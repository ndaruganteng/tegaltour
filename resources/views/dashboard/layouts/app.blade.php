...
<body class="sidebar-mini layout-fixed sidebar-open bg-dark">
    ...
    <script>
        $(document).ready(function() {
            $('#ordermasuk-table').DataTable();
        });
    </script>
    <script>
        $(document).ready(function() {
            $('#ordercancel-table').DataTable();
        });
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('#orderadminselesai-table').DataTable();
        });
    </script>
    <script>
        $(document).ready(function() {
            $('#orderadmincancel-table').DataTable();
        });
    </script>
    <script>
        $(document).ready(function() {
    ...
    <script>
        $(document).ready(function() {
            $('#pendapatanadmin-table').DataTable();
        });
    </script>
    <script>
        $(document).ready(function() {
            $('#jumlahpendapatanadmin-table').DataTable();
        });
    </script>
