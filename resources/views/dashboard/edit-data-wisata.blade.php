            ...
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card card-dark card-outline">
                        ...
                        <form class="form-sample" action="{{ url('/data-wisata/update/'.$wisata->id_wisata) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control" value="{{ $wisata->image}}"
                                                    name="image">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            @if ($wisata->image)
                                            <img src="{{asset('storage/image/wisata/'.$wisata->image)}}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="namawisata" class="col-sm-3 col-form-label">Nama Paket
                                                Wisata</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{ $wisata->namawisata}}"
                                                    name="namawisata">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{ $wisata->durasi}}"
                                                    name="durasi">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select class="custom-select form-control" name="kategori">
                                                    ...
                                                    <option value="{{$data->id_kategori}}"
                                                        {{ $data->id_kategori == $wisata->kategori ? 'selected' : '' }}>
                                                        {{$data->nama_kategori}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="jamberangkat" class="col-sm-3 col-form-label">Jam
                                                Berangkat</label>
                                            <div class="col-sm-9">
                                                <input type="time" class="form-control"
                                                    value="{{ $wisata->jamberangkat}}" name="jamberangkat">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="3"
                                                    name="lokasi">{{ $wisata->lokasi}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $wisata->linklokasi}}"
                                        name="linklokasi">
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi Wisata</label>
                                    <input id="deskripsi" type="hidden" value="{{ $wisata->deskripsi}}"
                                        name="deskripsi">
