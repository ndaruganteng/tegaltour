                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <div class="card card-dark card-outline">
                            <div class="card-body">
                                <img src="{{asset('storage/image/wisata/'.$data_wisata_detail->image)}}"
                        ...
                        <div class="card card-dark card-outline">
                            <div class="card-body">
                                ...
                                <p class="card-text">Harga/Orang : Rp
                                    {{ number_format($data_wisata_detail->harga, 0, ',', '.') }}</p>
                                <p class="card-text">Titik Kumpul : {{ $data_wisata_detail->titikkumpul }}</p>
                                <p class="card-text">Tanggal Berangkat :
                                    {{ \Carbon\Carbon::parse($data_wisata_detail->tanggalberangkat)->locale('id')->isoFormat('dddd, D MMMM Y') }}
                                </p>
                                <a type="button" href="{{ $data_wisata_detail->linklokasi }}" target="_blank"
                                    class="btn btn-dark btn-sm d-block shadow-0 me-2"><i
