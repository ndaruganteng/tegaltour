...
<div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-dark card-outline">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="datacust-table" class="table table-striped table-bordered text-center"
                                    style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Foto Profile</th>
    ...
    <div class="modal fade" id="tambahadmin" tabindex="-1" role="dialog" aria-labelledby="tambahadminTitle"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="/register_admin" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <p style="font-style: italic; font-size: 10px;">size foto maksimal 2 mb dan extensi
                                        jpg, png, jpeg</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-grup">
                                    <img id="image-preview" src="" class="rounded-circle border border-2 border-dark"
                                        style="display:none; max-width: 100px; max-height: 100px;" alt="Preview Image">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required="required"
                                value="{{ old('nama_lengkap') }}" name="nama_lengkap"
                                placeholder="Masukan Nama Lengkap">
                        </div>
                        <div class="form-group">
                            <label for="no_telepon">Nomor Telepon</label>
                            <input type="text" class="form-control" required="required" value="{{ old('no_telepon') }}"
                                name="no_telepon" placeholder="Masukan Nomor Telepon"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" required="required" value="{{ old('email') }}"
                                name="email" placeholder="Masukan Email">
                        </div>
                        <div class="form-group">
                            <label for="alamat">Alamat</label>
                            <input type="text" class="form-control" required="required" value="{{ old('alamat') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control" required="required"
                                    value="{{ old('password') }}" name="password_confirmation" id="confirm_password"
                                    placeholder="Masukan Password">
                                <div class="input-group-append">
