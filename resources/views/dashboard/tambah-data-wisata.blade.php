            ...
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card card-dark card-outline">
                        ...
                        <div class="card-body">
                            <form class="form-sample" action="{{ route('Wisata.index') }}" method="post"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control" required="required" name="image"
                                                    accept="image/*" id="image" onchange="previewImage(event)">
                                                <p class="text-secondary" style="font-size: 14px; font-style: italic;">
                                                    size foto maksimal 2 mb dan extensi jpg, png, jpeg</p>
                                                @if ($errors->has('image'))
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="namawisata" class="col-sm-3 col-form-label">Nama Paket
                                                Wisata</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" required="required"
                                                    name="namawisata" value="{{ old('namawisata') }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" required="required"
                                                    ...
                                                    placeholder="Masukan Kuota Tour">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="custom-select form-control" required="required"
                                                    name="kategori">
                                                    <option value="">Pilih Kategori Wisata</option>
                                                    @foreach($kategori as $data)
                                                    <option value="{{$data->id_kategori}}"
                                                        {{ old('kategori') == $data->id_kategori ? 'selected' : '' }}>
                                                        {{$data->nama_kategori}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="jam_berangkat" class="col-sm-3 col-form-label">Jam
                                                Berangkat</label>
                                            <div class="col-sm-9">
                                                <input type="time" class="form-control" required="required"
                                                    name="jamberangkat" value="{{ old('jam_berangkat') }}"
                                                    placeholder="Masukan Titik Kumpul Wisata">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="tanggalberangkat" class="col-sm-3 col-form-label">Tanggal
                                                Berangkat</label>
                                            <div class="col-sm-9">
                                                <input type="date" value="{{ old('tanggalberangkat') }}"
                                                    class="form-control" required="required" name="tanggalberangkat"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="titikkumpul" class="col-sm-3 col-form-label">Titik
                                                Kumpul</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{ old('titikkumpul') }}"
                                                    required="required" name="titikkumpul"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="lokasi" class="col-sm-3 col-form-label">Destinasi Wisata</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{ old('lokasi') }}"
                                                    required="required" name="lokasi"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required="required"
                                        value="{{ old('linklokasi') }}" name="linklokasi"
