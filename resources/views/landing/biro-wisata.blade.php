                    ...
                    @if($p->role == 'mitra')
                        <div class="col-md-12 col-lg-3">
                            <div class="card card-biro" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-center" style="margin-top: -20px; font-size: 16px;">{{$p->nama_lengkap}} <i class="fas fa-check-circle" style="color: #1fbd00"></i></h5>
                                    <div class="text-center mt-3">
                                        <a href="detail-biro-wisata/{{ ($p->id) }}#{{$p->nama_lengkap}}" class="btn btn-dark shadow-0 rounded-lg" style="text-transform: lowercase;">Lihat Produk</a>
                                    </div>
                                </div>
                            </div>
                        </div>
