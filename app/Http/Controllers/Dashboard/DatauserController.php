...
class DatauserController extends Controller
{
    ...
    // view data user biro wisata
    public function userbiro()
    {   
    	$users = DB::table('users')->get();
        return view('dashboard.data-user-biro-wisata',['users' => $users]);
    }
    
    public function pengguna()
    {   
    	$users = DB::table('users')->get();
        return view('dashboard.data-user-wisatawan',['users' => $users]);
    }
